...
def find_kth_optimizer(stage_events, k):
    ...
    try:
        ...
        # If no optimizer events found, use the last event as a fallback
        if stage_events:
            return stage_events[-1]
        else:
            raise ValueError("No events found in stage")
...
if __name__ == "__main__":
    ...
    """
    python visualize_pipeline.py -i temp/temp.json -o temp/temp.svg -n 0 -w 1000 -c
    """